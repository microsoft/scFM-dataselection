...
class CellMultisetDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        green("data df before harmonize_cell_types")
        print(self.data_df)
        self.data_df = self.harmonize_cell_types(self.data_df)

        green("data df after harmonize_cell_types")
        print(self.data_df)
        ...
        green("val df after deleting data df")
        print(self.val_df)
        green("train df after deleting data df")
        print(self.train_df)
        ...
        green("val df after removing singleton classes")
        print(self.val_df)
        green("train df after removing singleton classes")
        print(self.train_df)
        ...
        green("val df after get_sampler_weights and map_cell_type_id2name")
        print(self.val_df)
        green("train df after get_sampler_weights and map_cell_type_id2name")
        print(self.train_df)

        green("logging train and val data size")
